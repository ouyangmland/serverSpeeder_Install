...
URLKernel='https://raw.githubusercontent.com/ouyangmland/serverSpeeder_kernel/master/serverSpeeder.txt'
...
wget --no-check-certificate -q -O "/tmp/appex/apxfiles/bin/acce-"$KNV"-["$KNA"_"$KNN"_"$KNK"]" "https://raw.githubusercontent.com/ouyangmland/serverSpeeder_kernel/master/$MyKernel"
...
wget --no-check-certificate -q -O "/appex/etc/apx.lic" "http://speedsvip.000webhostapp.com/apx.php?mac=$MAC"
...
{
[ ! -f /tmp/appex.zip ] && wget --no-check-certificate -q -O "/tmp/appex.zip" "https://raw.githubusercontent.com/ouyangmland/serverSpeeder_Install/master/appex.zip"
