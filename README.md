...
Install
```
wget --no-check-certificate -O appex.sh https://raw.githubusercontent.com/ouyangmland/serverSpeeder_Install/master/appex.sh && chmod +x appex.sh && bash appex.sh install

```    
Uninstall    
```
wget --no-check-certificate -O appex.sh https://raw.githubusercontent.com/ouyangmland/serverSpeeder_Install/master/appex.sh && chmod +x appex.sh && bash appex.sh uninstall
